    ...
    <div class="container text-start">
        <form method="POST" action="{{ route('data.personal.submit') }}">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" id="nama" value="{{ $data['nama'] ?? '' }}" class="form-control form-global" placeholder="Nama Sesuai e-KTP">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Nomor e-KTP</label>
                <input type="text" id="nik" value="{{ $data['nik'] ?? '' }}" class="form-control form-global" placeholder="Nomor e-KTP">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Tempat Lahir</label>
                <input type="text" id="tenpat_lahir" value="{{ $data['tempat_lahir'] ?? '' }}" class="form-control form-global" placeholder="Tempat Lahir">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Tanggal Lahir</label>
                <input type="text" id="tanggal_lahir" value="{{ $data['tanggal_lahir'] ?? '' }}"  class="form-control form-global" placeholder="Tanggal Lahir">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Jenis Kelamin</label>
                <select id="genderSelect" class="form-control" data-selected="{{ $data['jenis_kelamin'] ?? '' }}">
                    <option value="">Pilih Jenis Kelamin</option>
                </select>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Agama</label>
                <select id="religionSelect" class="form-control" data-selected="{{ $data['agama'] ?? '' }}">
                    <option value="">Pilih Agama</option>
                </select>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Status Perkawinan</label>
                <select id="maritalSelect" class="form-control" data-selected="{{ $data['status_perkawinan'] ?? '' }}">
                    <option value="">Pilih Status Perkawinan</option>
                </select>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Nama Gadis Ibu Kandung</label>
                <input type="text" id="username" class="form-control form-global" placeholder="Nama Gadis Ibu Kandung">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Alamat Sesuai e-KTP</label>
                <input type="text" id="alamat" value="{{ $data['alamat'] ?? '' }}" class="form-control form-global" placeholder="Alamat Sesuai e-KTP">
            </div>
            <div class="form-group mb-4">
                <div class="row">
                    <div class="col-6">
                        <label class="form-label text-white text-form-global mb-2">RT</label>
                        <input type="text" id="rt" class="form-control" value="{{ $rt }}">
                    </div>
                    <div class="col-6">
                        <label class="form-label text-white text-form-global mb-2">RW</label>
                        <input type="text" id="rw" class="form-control" value="{{ $rw }}">
                    </div>
                </div>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Kota</label>
                <input type="text" id="kota" value="{{ $data['kota'] ?? '' }}" class="form-control form-global" placeholder="Kota">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Kelurahan</label>
                <input type="text" id="kelurahan" value="{{ $data['kelurahan'] ?? '' }}" class="form-control form-global" placeholder="Kelurahan">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Kecamatan</label>
                <input type="text" id="kecamatan" value="{{ $data['kecamatan'] ?? '' }}" class="form-control form-global" placeholder="Kecamatan">
            </div>
