    ...
    <div class="container text-start">
        ...
        <form method="POST" action="{{ route('data.pekerjaan.submit') }}">
            ...
            <div class="form-group mb-4">
                ...
                <select name="employment" id="employmentSelect" class="form-control form-global">
            ...
            <div class="form-group mb-4">
                ...
                <input type="text" name="company_name" id="company_name" class="form-control form-global" placeholder="Tulis Nama Perusahaan">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Jabatan</label>
                <select name="position" id="positionSelect" class="form-control form-global">
                    <option value="">Pilih Jabatan</option>
                </select>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Bidang Usaha</label>
                <select name="businessline" id="businesslineSelect" class="form-control form-global">
            ...
            <div class="form-group mb-4">
                ...
                <div class="row">
                    <div class="col-6">
                        <input type="text" name="work_year" id="work_year" class="form-control form-global" placeholder="Tahun">
                    </div>
                    <div class="col-6">
                        <input type="text" name="work_month" id="work_month" class="form-control form-global" placeholder="Bulan">
                    </div>
                </div>
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Alamat Perusahaan</label>
                <input type="text" name="office_address" id="office_address" class="form-control form-global" placeholder="Tulis Alamat Perusahaan">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Kode Pos</label>
                <input type="text" name="office_postal_code" id="office_postal_code" class="form-control form-global" placeholder="Tulis Kode Pos">
            </div>
            <div class="form-group mb-4">
                <label class="form-label text-white text-form-global mb-2">Telepon Kantor</label>
                <input type="text" name="office_phone" id="office_phone" class="form-control form-global" placeholder="Tulis Telepon Kantor">
            </div>
