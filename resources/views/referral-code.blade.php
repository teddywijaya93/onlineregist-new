...
<section class="auth-wrapper">
    <div class="container text-center">
        ...
        <div class="form-group text-start mb-4">
            ...
            <input type="text" name="kode_id" class="form-control form-global" placeholder="Masukan Kode ID disini" autocomplete="off" required>
        </div>
        <div class="form-group text-start mb-4">
            <label class="form-label text-white text-form-global mb-2">Kode Referral</label>
            <input type="text" name="kode_id" class="form-control form-global" placeholder="Masukan Kode Referral disini" autocomplete="off" required>
        </div>
